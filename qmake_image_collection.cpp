/****************************************************************************
** Image collection for project 'WM3000I'.
**
...
**      images/searchfind_2
**
** Created: Mo Mär 13 14:49:15 2006
...
class MimeSourceFactory_WM3000I : public QMimeSourceFactory
{
public:
    MimeSourceFactory_WM3000I() {}
    ~MimeSourceFactory_WM3000I() {}
...
void qInitImages_WM3000I()
{
    if ( !factory ) {
	factory = new MimeSourceFactory_WM3000I;
	QMimeSourceFactory::defaultFactory()->addFactory( factory );
    }
}

void qCleanupImages_WM3000I()
{
    if ( factory ) {
...
class StaticInitImages_WM3000I
{
public:
    StaticInitImages_WM3000I() { qInitImages_WM3000I(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_WM3000I() { }
#else
    ~StaticInitImages_WM3000I() { qCleanupImages_WM3000I(); }
#endif
};

static StaticInitImages_WM3000I staticImages;
